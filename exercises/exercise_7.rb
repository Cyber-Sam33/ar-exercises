...
puts  "What is the name of the store you want to create?"
user_input = gets.chomp

create_store = Store.create(name: user_input)
...
# 4. Display the error messages provided back from ActiveRecord to the user (one on each line) after you attempt 
